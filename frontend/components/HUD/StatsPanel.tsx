    ...
    <View style={styles.panel}>
      ...
      <View style={styles.metrics}>
        ...
        <View style={styles.metric}>
          ...
          <Text style={styles.metricDelta}>LVL {session.investor_rank}</Text>
        </View>
      </View>

      {/* Right: stat bars */}
      <View style={styles.bars}>
        <StatBar label="CAPITAL" value={capitalNorm} color={Colors.amber} />
        <StatBar label="PROGRESS" value={session.progress} color={Colors.blue} />
        <StatBar label="RANK" value={(session.investor_rank - 1) / 3} color={Colors.teal} />
      </View>
    </View>
  );
}
