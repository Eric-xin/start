...
TEMPLATES: dict[str, list[tuple[str, str, str]]] = {
    ...
    "rate_hike": [
        ...
        ("Mortgage Rates Climb to Multi-Decade Highs",
         "The 30-year fixed rate crossed 7.5%, adding roughly CHF400/month in payments on a median-priced home versus one year ago.",
         "bearish"),
        ("Corporate Debt Refinancing Stress Mounts",
         "Companies face a 'maturity wall' of CHF1.2 trillion in bonds due by year-end, many issued when rates were near zero.",
         "bearish"),
        ("Money Market Funds Draw Record Inflows as Rate Outlook Rises",
         "Investors poured CHF78 billion into money market funds this week, seeking safety and yield as rate hike expectations climbed.",
         "mixed"),
    ],
    "rate_cut": [
    ...
    "market_rally": [
        ...
        ("Foreign Investor Flows Into US Equities Hit Record",
         "International asset managers increased US equity exposure by CHF47 billion in the latest week, the largest single-week inflow on record.",
         "bullish"),
        ...
        ("Buyback Authorizations Surge as Companies Signal Confidence",
         "S&P 500 companies announced CHF280 billion in share repurchase programs this quarter, the highest since 2022 and a historically bullish signal.",
         "bullish"),
    ],
    "crypto_volatility": [
        ...
        ("Stablecoin Supply Contracts for Fourth Consecutive Week",
         "The aggregate market cap of USDT and USDC fell CHF8 billion, reducing the 'dry powder' available for crypto spot purchases.",
         "bearish"),
        ...
        ("Institutional Bitcoin ETF Inflows Accelerate",
         "Spot Bitcoin ETFs collectively recorded CHF1.2 billion in net inflows over five consecutive sessions, the longest streak since approval.",
         "bullish"),
    ...
    "gold_move": [
        ...
        ("ETF Gold Holdings Surge as Geopolitical Risks Mount",
         "Physical gold ETFs saw CHF3.2 billion in inflows over the past five trading sessions, the largest such streak in two years.",
         "bullish"),
    ...
    "bond_market": [
        ...
        ("Corporate Bond Issuance Surges Ahead of Expected Rate Volatility",
         "Investment-grade companies rushed to market with CHF48 billion in new bonds this week, locking in current rates before policy uncertainty returns.",
         "mixed"),
    ...
    "geopolitical": [
        ("Trade Tariff Escalation Threatens Supply Chains",
         "New tariff announcements covering CHF300 billion in goods prompted swift retaliation, with analysts warning of a 0.4% hit to global GDP.",
         "bearish"),
