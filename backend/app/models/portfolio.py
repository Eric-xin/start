...
from sqlalchemy import String, Float, Integer, BigInteger, DateTime, Date, JSON, ForeignKey, func
...
class CardPlay(Base):
    ...
    portfolio: Mapped["UserPortfolio"] = relationship("UserPortfolio", back_populates="card_plays")
...
class NetWorthSnapshot(Base):
    ...
    portfolio: Mapped["UserPortfolio"] = relationship("UserPortfolio", back_populates="net_worth_snapshots")
